    ...
    typeof exports === 'object' && typeof module !== 'undefined'
        ...
        typeof define === 'function' && define.amd ? define([
            ...
            (global = typeof globalThis !== 'undefined' ? globalThis : global ||
                self, global.Collapse = factory(global.Data,
    ...
    (function (Data, EventHandler, Manipulator, SelectorEngine, BaseComponent) {
        ...
        class Collapse extends BaseComponent__default.default {
            constructor (element, config) {
                ...
                this._triggerArray = []
                const toggleList = SelectorEngine__default.default.find(
                    SELECTOR_DATA_TOGGLE)

                for (let i = 0, len = toggleList.length; i < len; i++) {
                    const elem = toggleList[i]
                    const selector = getSelectorFromElement(elem)
                    const filterElement = SelectorEngine__default.default.find(
                        selector).
            ...
            show () {
                ...
                if (this._config.parent) {
                    const children = SelectorEngine__default.default.find(
                        CLASS_NAME_DEEPER_CHILDREN, this._config.parent)
                    actives = SelectorEngine__default.default.find(
                        SELECTOR_ACTIVES, this._config.parent).
        ...
        EventHandler__default.default.on(document, EVENT_CLICK_DATA_API,
            SELECTOR_DATA_TOGGLE, function (event) {
                ...
                const selectorElements = SelectorEngine__default.default.find(
                    selector)
