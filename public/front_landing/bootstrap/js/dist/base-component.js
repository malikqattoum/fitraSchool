...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined'
        ...
        typeof define === 'function' && define.amd ? define(
                ['./dom/data', './dom/event-handler'], factory) :
            (global = typeof globalThis !== 'undefined' ? globalThis : global ||
                self, global.Base = factory(global.Data, global.EventHandler))
    ...
    class BaseComponent {
        constructor (element) {
            ...
            Data__default.default.set(this._element, this.constructor.DATA_KEY,
                this)
        }

        dispose () {
            Data__default.default.remove(this._element,
        ...
        static getInstance (element) {
            return Data__default.default.get(getElement(element),
                this.DATA_KEY)
        }
