    ...
    typeof exports === 'object' && typeof module !== 'undefined'
        ...
        typeof define === 'function' && define.amd ? define([
            ...
            (global = typeof globalThis !== 'undefined' ? globalThis : global ||
                self, global.Tab = factory(global.EventHandler,
                global.SelectorEngine, global.Base))
    ...
    class Tab extends BaseComponent__default.default {
        ...
        show () {
            ...
            if (listElement) {
                ...
                listElement.nodeName === 'OL'
                    ? SELECTOR_ACTIVE_UL
                    : SELECTOR_ACTIVE
                previous = SelectorEngine__default.default.find(itemSelector,
                    listElement)
                previous = previous[previous.length - 1]
            }

            const hideEvent = previous ? EventHandler__default.default.trigger(
                previous, EVENT_HIDE, {
        ...
        _activate (element, container, callback) {
            ...
            (container.nodeName === 'UL' || container.nodeName === 'OL')
                ? SelectorEngine__default.default.find(SELECTOR_ACTIVE_UL,
                    container)
                : SelectorEngine__default.default.children(container,
                    SELECTOR_ACTIVE)
            ...
            if (parent && parent.classList.contains(CLASS_NAME_DROPDOWN_MENU)) {
                ...
                if (dropdownElement) {
                    SelectorEngine__default.default.find(
                        SELECTOR_DROPDOWN_TOGGLE, dropdownElement).
