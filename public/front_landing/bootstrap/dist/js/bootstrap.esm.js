...
class Carousel extends BaseComponent {
    constructor (element, config) {
        ...
        this._indicatorsElement = SelectorEngine.findOne(SELECTOR_INDICATORS,
            this._element)
    ...
    _addTouchEventListeners () {
        const hasPointerPenTouch = event => {
            return this._pointerEvent &&
                (event.pointerType === POINTER_TYPE_PEN || event.pointerType ===
                    POINTER_TYPE_TOUCH)
        }
    ...
    show () {
        ...
        if (this._config.parent) {
            ...
            actives = SelectorEngine.find(SELECTOR_ACTIVES,
                this._config.parent).filter(elem => !children.includes(elem)) // remove children if greater depth
        }
...
class Dropdown extends BaseComponent {
    ...
    static clearMenus (event) {
        if (event &&
            (event.button === RIGHT_MOUSE_BUTTON || event.type === 'keyup' &&
                event.key !== TAB_KEY$1)) {
            return
        }
...
class Tooltip extends BaseComponent {
    ...
    hide () {
        ...
        if ('ontouchstart' in document.documentElement) {
            [].concat(...document.body.children).
                forEach(
                    element => EventHandler.off(element, 'mouseover', noop))
        }
            ...
            SelectorEngine.parents(link, SELECTOR_NAV_LIST_GROUP$1).
                forEach(listGroup => {
                    ...
                    SelectorEngine.prev(listGroup,
                        ...
                        forEach(
                            item => item.classList.add(CLASS_NAME_ACTIVE$1)) // Handle special case when .nav-link is inside .nav-item
