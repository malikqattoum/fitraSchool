...
(function (global, factory) {
    ...
    const typeCheckConfig = (componentName, config, configTypes) => {
        Object.keys(configTypes).forEach(property => {
            ...
            const valueType = value && isElement$1(value) ? 'element' : toType(
                value)
    ...
    function addHandler (
        ...
        const uid = getUidEvent(originalHandler,
            originalTypeEvent.replace(namespaceRegex, ''))
        const fn = delegation ? bootstrapDelegationHandler(element, handler,
            ...
            Object.keys(storeElementEvent).forEach(keyHandlers => {
                ...
                if (!inNamespace || originalTypeEvent.includes(handlerKey)) {
                    ...
                    removeHandler(element, events, typeEvent,
                        event.originalHandler, event.delegationSelector)
                }
            })
        },
    ...
    class Alert extends BaseComponent {
        ...
        close () {
            ...
            const isAnimated = this._element.classList.contains(
                CLASS_NAME_FADE$5)
        ...
        getDataAttributes (element) {
            ...
            Object.keys(element.dataset).
                ...
                forEach(key => {
                    ...
                    pureKey = pureKey.charAt(0).toLowerCase() +
    ...
    const SelectorEngine = {
        ...
        focusableChildren (element) {
            const focusables = [
                ...
                'details',
                '[tabindex]',
                '[contenteditable="true"]'].map(
                selector => `${selector}:not([tabindex^="-"])`).join(', ')
    ...
    class Carousel extends BaseComponent {
        constructor (element, config) {
            ...
            this._indicatorsElement = SelectorEngine.findOne(
                SELECTOR_INDICATORS, this._element)
        ...
        _setActiveIndicatorElement (element) {
            if (this._indicatorsElement) {
                const activeIndicator = SelectorEngine.findOne(
                    SELECTOR_ACTIVE$1, this._indicatorsElement)
                ...
                for (let i = 0; i < indicators.length; i++) {
                    if (Number.parseInt(
                            indicators[i].getAttribute('data-bs-slide-to'), 10) ===
        ...
        _slide (directionOrOrder, element) {
            ...
            const activeElement = SelectorEngine.findOne(SELECTOR_ACTIVE_ITEM,
                this._element)

            const activeElementIndex = this._getItemIndex(activeElement)

            const nextElement = element ||
                this._getItemByOrder(order, activeElement)
    ...
    class Collapse extends BaseComponent {
        ...
        show () {
            ...
            if (actives.length) {
                ...
                activesData = tempActiveData ? Collapse.getInstance(
                    tempActiveData) : null
            ...
            const startEvent = EventHandler.trigger(this._element,
                EVENT_SHOW$5)
        ...
        _initializeChildren () {
            ...
            SelectorEngine.find(SELECTOR_DATA_TOGGLE$4, this._config.parent).
                ...
                forEach(element => {
                    ...
                    if (selected) {
                        this._addAriaAndCollapsedClass([element],
    ...
    function getContainingBlock (element) {
        ...
        ['html', 'body'].indexOf(getNodeName(currentNode)) < 0) {
            ...
            if (css.transform !== 'none' || css.perspective !== 'none' ||
                ...
                isFirefox && css.willChange === 'filter' || isFirefox &&
    ...
    function mapToStyles (_ref2) {
        ...
        if (adaptive) {
            ...
            if (placement === top ||
                (placement === left || placement === right) && variation ===
                end) {
            ...
            if (placement === left ||
                (placement === top || placement === bottom) && variation ===
                end) {
        ...
        if (gpuAcceleration) {
            ...
            return Object.assign({}, commonStyles,
                (_Object$assign = {}, _Object$assign[sideY] = hasY
                    ? '0'
                    : '', _Object$assign[sideX] = hasX
                    ? '0'
                    : '', _Object$assign.transform = (win.devicePixelRatio ||
                    1) <= 1
                    ? 'translate(' + x + 'px, ' + y + 'px)'
                    : 'translate3d(' + x + 'px, ' + y +
                    'px, 0)', _Object$assign))
        ...
        return Object.assign({}, commonStyles,
            (_Object$assign2 = {}, _Object$assign2[sideY] = hasY
                ? y + 'px'
    ...
    function getDocumentRect (element) {
        ...
        var width = max(html.scrollWidth, html.clientWidth,
            body ? body.scrollWidth : 0, body ? body.clientWidth : 0)
        var height = max(html.scrollHeight, html.clientHeight,
  ...
  */
    ...
    function detectOverflow (state, options) {
        ...
        var clippingClientRect = getClippingRect(
            isElement(element) ? element : element.contextElement ||
    ...
    function computeAutoPlacement (state, options) {
        ...
        var placements$1 = variation ? flipVariations
            ? variationPlacements
    ...
    function flip (_ref) {
        ...
        var _options$mainAxis = options.mainAxis,
            checkMainAxis = _options$mainAxis === void 0
                ? true
                : _options$mainAxis,
            _options$altAxis = options.altAxis,
            checkAltAxis = _options$altAxis === void 0
                ? true
                : _options$altAxis,
    ...
    function offset (_ref2) {
        ...
        var data = placements.reduce(function (acc, placement) {
            acc[placement] = distanceAndSkiddingToXY(placement, state.rects,
                offset)
            return acc
        }, {})
    ...
    function preventOverflow (_ref) {
        ...
        var _options$mainAxis = options.mainAxis,
            ...
            tetherOffset = _options$tetherOffset === void 0
                ? 0
        ...
        if (checkMainAxis || checkAltAxis) {
            ...
            var minOffset = isBasePlacement
                ? referenceRect[len] / 2 - additive - arrowLen -
            ...
            var offsetModifierValue = state.modifiersData.offset
                ...
                : 0
            var tetherMin = popperOffsets[mainAxis] + minOffset -
                offsetModifierValue - clientOffset
            var tetherMax = popperOffsets[mainAxis] + maxOffset -
                offsetModifierValue
            ...
            if (checkAltAxis) {
                ...
                var _preventedOffset = within(
                    tether ? min(_min, tetherMin) : _min, _offset,
    ...
    function mergeByName (modifiers) {
        var merged = modifiers.reduce(function (merged, current) {
            ...
            merged[current.name] = existing ? Object.assign({}, existing,
                current, {
        ...
        return function createPopper (reference, popper, options) {
            ...
            var instance = {
                ...
                setOptions: function setOptions (setOptionsAction) {
                    ...
                    state.options = Object.assign({}, defaultOptions,
                        state.options, options)
                    state.scrollParents = {
                        reference: isElement(reference) ? listScrollParents(
                            reference) : reference.contextElement
                ...
                forceUpdate: function forceUpdate () {
                    ...
                    state.orderedModifiers.length; index++) {
    ...
    class Dropdown extends BaseComponent {
        ...
        _createPopper (parent) {
            ...
            this._popper = createPopper(referenceElement, this._menu,
                popperConfig)
            ...
            for (let i = 0, len = toggles.length; i < len; i++) {
                ...
                if (event) {
                    ...
                    if (composedPath.includes(context._element) ||
                        ...
                        !isMenuTarget || context._config.autoClose ===
        ...
        static dataApiKeydownHandler (event) {
            ...
            if (/input|textarea/i.test(event.target.tagName) ? event.key ===
                SPACE_KEY || event.key !== ESCAPE_KEY$2 &&
                (event.key !== ARROW_DOWN_KEY && event.key !== ARROW_UP_KEY ||
                    event.target.closest(SELECTOR_MENU)) : !REGEXP_KEYDOWN.test(
                event.key)) {
                return
            }
    ...
    EventHandler.on(document, EVENT_KEYDOWN_DATA_API, SELECTOR_DATA_TOGGLE$3,
    ...
    class FocusTrap {
        ...
        activate () {
            ...
            EventHandler.on(document, EVENT_FOCUSIN$1,
                event => this._handleFocusin(event))
            EventHandler.on(document, EVENT_KEYDOWN_TAB,
    ...
    class Modal extends BaseComponent {
        ...
        show (relatedTarget) {
            ...
            EventHandler.on(this._dialog, EVENT_MOUSEDOWN_DISMISS, () => {
                EventHandler.one(this._element, EVENT_MOUSEUP_DISMISS,
                    event => {
        ...
        dispose () {
            [window, this._dialog].forEach(
                htmlElement => EventHandler.off(htmlElement, EVENT_KEY$6))
        ...
        _showElement (relatedTarget) {
            ...
            const modalBody = SelectorEngine.findOne(SELECTOR_MODAL_BODY,
                this._dialog)
        ...
        _setEscapeEvent () {
            if (this._isShown) {
                EventHandler.on(this._element, EVENT_KEYDOWN_DISMISS$1,
                    event => {
                        if (this._config.keyboard && event.key ===
                            ESCAPE_KEY$1) {
                            event.preventDefault()
                            this.hide()
    ...
    EventHandler.on(document, EVENT_CLICK_DATA_API$1, SELECTOR_DATA_TOGGLE$1,
        function (event) {
            const target = getElementFromSelector(this)
    ...
    const allowedAttribute = (attribute, allowedAttributeList) => {
        ...
        const regExp = allowedAttributeList.filter(
            attributeRegex => attributeRegex instanceof RegExp) // Check if a regular expression validates the attribute.
    ...
    function sanitizeHtml (unsafeHtml, allowList, sanitizeFn) {
        ...
        for (let i = 0, len = elements.length; i < len; i++) {
            ...
            const allowedAttributes = [].concat(allowList['*'] || [],
    ...
    class Tooltip extends BaseComponent {
        ...
        dispose () {
            ...
            EventHandler.off(this._element.closest(SELECTOR_MODAL),
                EVENT_MODAL_HIDE, this._hideModalHandler)
        ...
        show () {
            ...
            if (this.constructor.NAME === 'tooltip' && this.tip &&
                this.getTitle() !==
        ...
        hide () {
            ...
            if ('ontouchstart' in document.documentElement) {
                [].concat(...document.body.children).
                    forEach(element => EventHandler.off(element, 'mouseover',
                        noop))
            }
        ...
        setContent (tip) {
            this._sanitizeAndSetContent(tip, this.getTitle(),
        ...
        getTitle () {
            const title = this._element.getAttribute(
                'data-bs-original-title') || this._config.title
        ...
        _initializeOnDelegatedTarget (event, context) {
            return context ||
                this.constructor.getOrCreateInstance(event.delegateTarget,
        ...
        _addAttachmentClass (attachment) {
            this.getTipElement().
                classList.
                add(`${this._getBasicClassPrefix()}-${this.updateAttachment(
                    attachment)}`)
        }
        ...
        _setListeners () {
            ...
            triggers.forEach(trigger => {
                if (trigger === 'click') {
                    ...
                    EventHandler.on(this._element, eventIn,
                        this._config.selector, event => this._enter(event))
                    EventHandler.on(this._element, eventOut,
                        this._config.selector, event => this._leave(event))
                }
            })
            ...
            EventHandler.on(this._element.closest(SELECTOR_MODAL),
                EVENT_MODAL_HIDE, this._hideModalHandler)
        ...
        _leave (event, context) {
            ...
            if (event) {
                context._activeTrigger[event.type === 'focusout'
                    ? TRIGGER_FOCUS
                    : TRIGGER_HOVER] = context._element.contains(
                    event.relatedTarget)
            }
        ...
        _getConfig (config) {
            ...
            if (config.sanitize) {
                config.template = sanitizeHtml(config.template,
                    config.allowList, config.sanitizeFn)
            }
        ...
        _cleanTipClass () {
            const tip = this.getTipElement()
            const basicClassPrefixRegex = new RegExp(`(^|\\s)${this._getBasicClassPrefix()}\\S+`,
                'g')
            const tabClass = tip.getAttribute('class').
    ...
    class Popover extends Tooltip {
        ...
        setContent (tip) {
            ...
            this._sanitizeAndSetContent(tip, this._getContent(),
                SELECTOR_CONTENT)
        } // Private
    ...
    class ScrollSpy extends BaseComponent {
        ...
        refresh () {
            const autoMethod = this._scrollElement ===
            this._scrollElement.window ? METHOD_OFFSET : METHOD_POSITION
            ...
            targets.map(element => {
                ...
                const target = targetSelector ? SelectorEngine.findOne(
                    targetSelector) : null
        ...
        _process () {
            ...
            const maxScroll = this._config.offset + scrollHeight -
            ...
            for (let i = this._offsets.length; i--;) {
                const isActiveTarget = this._activeTarget !==
    ...
    class Tab extends BaseComponent {
        ...
        show () {
            ...
            if (listElement) {
                const itemSelector = listElement.nodeName === 'UL' ||
            ...
            const hideEvent = previous ? EventHandler.trigger(previous,
                EVENT_HIDE$1, {
                    relatedTarget: this._element,
                }) : null
        ...
        _activate (element, container, callback) {
            const activeElements = container &&
            (container.nodeName === 'UL' || container.nodeName === 'OL')
                ? SelectorEngine.find(SELECTOR_ACTIVE_UL, container)
                : SelectorEngine.children(container, SELECTOR_ACTIVE)
            const active = activeElements[0]
            const isTransitioning = callback && active &&
                active.classList.contains(CLASS_NAME_FADE$1)

            const complete = () => this._transitionComplete(element, active,
                callback)
            ...
            if (parent && parent.classList.contains(CLASS_NAME_DROPDOWN_MENU)) {
                ...
                if (dropdownElement) {
                    SelectorEngine.find(SELECTOR_DROPDOWN_TOGGLE,
                        dropdownElement).
                        forEach(dropdown => dropdown.classList.add(
                            CLASS_NAME_ACTIVE))
                }
    ...
    class Toast extends BaseComponent {
        ...
        _setListeners () {
            EventHandler.on(this._element, EVENT_MOUSEOVER,
                event => this._onInteraction(event, true))
            EventHandler.on(this._element, EVENT_MOUSEOUT,
                event => this._onInteraction(event, false))
            EventHandler.on(this._element, EVENT_FOCUSIN,
                event => this._onInteraction(event, true))
