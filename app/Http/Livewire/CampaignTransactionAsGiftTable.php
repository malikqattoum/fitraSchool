...
class CampaignTransactionAsGiftTable extends LivewireTableComponent
{
    ...
    protected string $pageName = 'campaign-transaction-as-gift-table';
    ...
    {
        return 'livewire-tables.rows.campaign_transaction_as_gift_table';
    }
    ...
    public function render()
    {
        ...
        return view('livewire-tables::'.config('livewire-tables.theme').'.datatable')
            ->with([
                ...
                'componentName' => 'admin.campaigns.campaign_transactions_as_gift.total-amount',
