...
<header class="wide-header header-3">
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-8 pr-0">
                    <div class="top-left">
                        ...
                        <a href="tel:{{ $settings['phone'] }}"><i class="fal fa-phone phone-alt"></i>{{ $settings['phone'] }}</a>
                    </div>
                </div>
        ...
        <div class="wide-wrap custom-wide-radius">
            <div class="container">
                        ...
                        <div class="menu-wrap">
                            <div class="main-menu">
                                <ul>
                                    ...
                                    <li><a href="#"
                                           class="{{ Request::is('faqs','events','teams','event-details/*') ? 'active' : '' }}">Pages</a>
                                    ...
                                    @if(getLogInUser())
                                        @if(getLogInUser()->hasRole('admin'))
                                            <a href="{{ route('admin.dashboard') }}"
                                               class="d-btn theme-btn">Dashboard</a>
                                        @else
                                            <a href="{{ route('user.dashboard') }}"
                                               class="d-btn theme-btn">Dashboard</a>
                                        @endif
                                    @else
                                        <a href="{{ route('register') }}" class="d-btn theme-btn custom-d-theme">Sign
                                            Up</a>
