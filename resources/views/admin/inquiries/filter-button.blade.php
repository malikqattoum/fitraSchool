    ...
    <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
        ...
        <div class="p-5">
            <div class="mb-5">
                ...
                {{ Form::select('status',  $status, null,['class' => 'form-control form-select','data-control'=>"select2" , 'id' => 'enquiriesStatus', 'wire:ignore']) }}
            </div>
            <div class="d-flex justify-content-end">
                <button type="reset"  id="enquiryResetFilter" class="btn btn-secondary">{{__('messages.common.reset')}}</button>
            </div>
        </div>
    </div>
</div>
