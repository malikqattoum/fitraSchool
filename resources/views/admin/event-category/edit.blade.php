<div class="modal fade" id="editEventCategoryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">{{ __('messages.event_category.edit_event_category') }}</h3>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
            </div>
            {{ Form::open(['id'=>'editEventCategoryForm','files' => true]) }}
            <div class="modal-body">
                ...
                <div class="mb-5">
                    {{ Form::hidden('id', null,['id' => 'editEventCategoryId']) }}
                    {{ Form::label('name',__('messages.common.name').(':'), ['class' => 'form-label required']) }}
                    {{ Form::text('name', null, ['class' => 'form-control', 'id' => 'editName', 'required', 'placeholder' => __('messages.campaign.enter_category_name')]) }}
                </div>
                <div class="mb-5">
