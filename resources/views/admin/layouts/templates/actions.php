<script id="actionsTemplates" type="text/x-jsrender">
    <a title = "<?php echo __('messages.common.edit') ?>"
        href="{{:editUrl}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-btn">
    ...
    <a title = "<?php echo __('messages.common.delete') ?>"
        href="#" data-id="{{:id}}" class="delete-btn btn btn-icon btn-bg-light text-hover-danger btn-sm">
                        <span class="svg-icon svg-icon-3">
