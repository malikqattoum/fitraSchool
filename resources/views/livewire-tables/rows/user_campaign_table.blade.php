<x-livewire-tables::bs5.table.cell>
    ...
    <div class="d-flex align-items-center">
        <a href="{{ route('user.campaigns.show',$row->id) }}">
            <div class="image image-circle image-mini me-3">
                <img src="{{$row->image}}" alt="user" class="user-img">
            </div>
        </a>
        <div class="d-flex flex-column">
            <a href="{{ route('user.campaigns.show',$row->id) }}" class="mb-1 text-decoration-none fs-6">
...
<x-livewire-tables::bs5.table.cell>
    <a data-turbo="false" title="Donors" class="btn btn-sm btn-primary me-5" href="{{ url('user/campaigns/'.$row->id.'?option=donors')}}">
...
<x-livewire-tables::bs5.table.cell>
    ...
    <div class="d-flex align-items-center justify-content-center">
        <a data-bs-toggle="tooltip"
           ...
           href="{{ route('user.campaigns.show', $row->id) }}" class="btn px-1 text-info fs-3"
           data-id="{{ $row->id}}">
            <i class="fa-solid fa-eye"></i>
        </a>
        <a data-bs-toggle="tooltip"
           title="{{ __('messages.common.edit') }}"
           href="{{  route('user.campaigns.edit', $row->id)}}"
           class="btn px-1 text-primary fs-3 user-campaign-edit-btn" data-id="{{$row->id}}"
        ...
        <a data-bs-toggle="tooltip"
           ...
           class="btn px-1 text-danger fs-3 user-campaign-delete-btn">
